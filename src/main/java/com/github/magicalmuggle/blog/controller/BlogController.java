...
import com.github.magicalmuggle.blog.entity.Blog;
import com.github.magicalmuggle.blog.entity.BlogListResult;
import com.github.magicalmuggle.blog.entity.BlogResult;
...
import com.github.magicalmuggle.blog.utils.AssertUtils;
...
public class BlogController {
    ...
    public BlogListResult getBlogs(
            @RequestParam("page") Integer page, @RequestParam(value = "userId", required = false) Integer userId) {
        if (page == null || page < 0) {
            page = 1;
        }
